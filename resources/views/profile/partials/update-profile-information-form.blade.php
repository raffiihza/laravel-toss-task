...
<!-- 
        ...
        <div>
            ...
            <input id="email" name="email" type="email" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400" value="{{ old('email', $user->email) }}" required autocomplete="username" />
