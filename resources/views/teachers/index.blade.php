            ...
            <tbody class="text-gray-600 text-sm">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td class="border border-gray-300 px-4 py-3">
                        <a href="{{ route('teachers.edit', $teacher->id) }}" class="bg-red-600 text-white px-4 py-2 rounded">Edit</a> 
                        ...
                        <form action="{{ route('teachers.reset-password', $teacher->id) }}" method="POST" class="inline">
                            @csrf
                            <button type="submit" class="bg-red-600 text-white px-4 py-2 rounded" onclick="return confirm('Apakah ingin mereset password ke sekolah123?')">Reset Password</button>
                        </form>
                    </td>
                </tr>
                @endforeach
