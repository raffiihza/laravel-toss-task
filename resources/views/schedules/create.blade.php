...
<div class="bg-white p-6 rounded-lg shadow-md">
    <h1 class="text-2xl font-bold mb-4 text-gray-700">Tambah Jadwal</h1>
    ...
    <form action="{{ route('schedules.store') }}" method="POST">
        ...
        <select id="teacher_id" name="teacher_id" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400" required>
        ...
        <x-input-label for="start_time" :value="__('Jam Mulai')" />
            <input type="time" id="start_time" name="start_time" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400" required>
            <x-input-error :messages="$errors->get('start_time')" class="mt-2" />
        </div>

        <div class="mb-4">
        <x-input-label for="end_time" :value="__('Jam Akhir')" />
            <input type="time" id="end_time" name="end_time" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400" required>
